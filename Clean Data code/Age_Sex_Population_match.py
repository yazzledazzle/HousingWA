...
Population_State_Sex_Age = pd.read_csv('Data/CSV/Population_State_Sex_Age.csv')
#date is dd-mm-yyyy
...
Population_State_Sex_Age.to_csv('/Users/yhanalucas/Desktop/Dashv1/Data/CSV/Population_State_Sex_Age_to_65+.csv', index=False)