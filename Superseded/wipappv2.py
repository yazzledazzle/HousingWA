...
app.layout = html.Div(className='page', children=[
    ...
    html.Div(className="content-section", children=[
        # Wait Turn section
        html.Div(className="wait-turn-section", children=[
            html.Div("Wait Turn Title", className="section-title"),
            # Add your dcc.Graphs and other components specific to wait-turn-section here
        ]),
        
        # Priority section
        html.Div(className='priority-section', children=[
            html.Div('Priority Title Text', className='section-title'),
            # Add table for Priority
